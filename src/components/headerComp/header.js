...
export function Header() {
  ...
  return (
    <div>
      <header className="bg-black/100 flex justify-between items-center py-3 px-4 fixed top-0 w-full z-10 md:w-full">
        <div className="px-5">
        ...
        >
          <ul
            className={`flex flex-col items-start gap-4 py-2 px-4 text-lg space-x-30 pb-20
        }`}
          >
            <Link href="/">
              <li>Main</li>
