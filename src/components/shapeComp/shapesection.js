  ...
  return (
    ...
    <div className="flex-col items-center justify-center">
      ...
      <div className="flex-col bg-[#1f0a24] items-center justify-center min-h-screen min-w-screen -z-0">
        ...
        <h4 className="text-center items-center justify-center font-semibold text-fuchsia-50 w-[50%] h-auto mx-auto text-[16px] pb-4">
          Taste uniqueness with a rollout that’s going to leave you shellshocked
          everyday only at b▲llAZZ the Deluxe Events Spot.
        </h4>
        ...
        <div className="text-center px-31 py-12 leadiing-8 flex flex-col items-center justify-center text-[17.2px]">
          <h1 className="pt-20 text-5xl font-stretch-expanded font-extrabold text-center text-fuchsia-50">
            b▲llAZZ EVENTS SPOT
          </h1>
          ...
          <p className="pb-6 leading-7 text-amber-100">
            ...
            in +234. Join us for extraordinary days of music, dance, and
            memories that will linger long forever. Welcome to
